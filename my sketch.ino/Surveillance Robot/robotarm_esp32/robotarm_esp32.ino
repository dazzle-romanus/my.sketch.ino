...
static const int ServoGPIO7 = 32;

static const int ServoGPIO8 = 13;

// Variables to store network name and password

const char* ssid = "luffy"; // Enter your network name

const char* password = "lovecook"; // Enter your network password
...
String valueString1 = String(150);

String valueString2 = String(180);

String valueString3 = String(180);

String valueString4 = String(70);

String valueString5 = String(50);

String valueString6 = String(70);

String valueString7 = String(90);

String valueString8 = String(90); 
...
void setup() {
  ...
  ObjServo7.attach(ServoGPIO7);

  ObjServo8.attach(ServoGPIO8);
...
void loop() {
  ...
  // Slider 7
    ...
    client.println("<p>Position 7: <span id=\"servoPos7\"></span></p>");

    client.println("<input type=\"range\" min=\"0\" max=\"180\" class=\"slider\" id=\"servoSlider7\" onchange=\"servo(this.value, 7)\" value=\"" + valueString7 + "\"/>");

    client.println("<button class=\"button\" onclick=\"decrementValue(7)\"style=\"font-size: 24px; padding: 10px 20px;\">-</button>");

    client.println("<button class=\"button\" onclick=\"incrementValue(7)\"style=\"font-size: 24px; padding: 10px 20px;\">+</button>");



// Slider 8

    client.println("<p>Position 8: <span id=\"servoPos8\"></span></p>");

    client.println("<input type=\"range\" min=\"0\" max=\"180\" class=\"slider\" id=\"servoSlider8\" onchange=\"servo(this.value, 8)\" value=\"" + valueString8 + "\"/>");

    client.println("<button class=\"button\" onclick=\"decrementValue(8)\"style=\"font-size: 24px; padding: 10px 20px;\">-</button>");

    client.println("<button class=\"button\" onclick=\"incrementValue(8)\"style=\"font-size: 24px; padding: 10px 20px;\">+</button>");
    ...
    client.println("var servoP7 = document.getElementById(\"servoPos7\");");

    client.println("slider7.oninput = function() { servoP7.innerHTML = this.value; }");



    client.println("var slider8 = document.getElementById(\"servoSlider8\");");

    client.println("var servoP8 = document.getElementById(\"servoPos8\");");

    client.println("slider8.oninput = function() { servoP8.innerHTML = this.value; }");
...
void setServoPosition(int servoNum, int value) {
  ...
  switch (servoNum) {
    ...
    case 8:
      ...
      ObjServo8.write(value);

      valueString8 = String(value);
